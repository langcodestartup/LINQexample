...
// 김민준
// 중
// Q. BMI는 몸무게(kg)을 키(m)의 제곱으로 나눠 계산합니다. (171cm, 60kg 일경우 60 / (1.71 * 1.71)으로 계산)
...
// 고
// Q. 8월 한 달 중에 사람들을 가장 많이 살찌운 음식을 찾아보려 합니다.
...
// 고
// Q. 8월 중에서, 하루에 섭취한 음식들의 칼로리 합계의 개인별 최대값을 기준으로 사람들을 내림차순으로 정렬하세요.
